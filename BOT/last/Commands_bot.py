    ...
    if messages['count'] >= 1:
        ...
        if not str(id) in ids:
            ...
            if body.lower() == 'hello':
                ...
                vk.method('messages.send', {'peer_id': id, 'message': users[n][-1] + ', Ваш баланс: ' + commands.bt(int(float(users[n][1])))})
                ...
                if int(users[n][4]) <= 0:
                    ...
                    vk.method('messages.send', {'peer_id': id, 'message': 'Вы заработали 100000'})
                    users[n][4] = str(60)
                else:
                    vk.method('messages.send',
                ...
                if int(users[n][3]) <= 0:
                    ...
                    vk.method('messages.send',
                              {'peer_id': id, 'message': 'Вы получили 1000000' + '\n' + 'Ваш баланс: ' + commands.bt(int(float(users[n][1])))})
                    users[n][3] = str(60)
                else:
                    vk.method('messages.send',
