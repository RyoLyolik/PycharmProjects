...
user = open('users.txt', 'r', encoding = 'windows-1251')
idss = open('allids.txt', 'r', encoding = 'windows-1251')
idc = open('allids.txt', 'a', encoding = 'windows-1251')
userc = open('users.txt', 'a', encoding = 'windows-1251')
ids = idss.read().split()
users = user.read()
users = users.split('\n')
...
while True:
            ...
            if not str(id) in ids:
                ...
                if body.lower() == 'hello':
                    ...
                    if users[n][5] == 'Admin':
                        ...
                        top = ''.join(top)
                    vk.method('messages.send',
                              {'peer_id': id, 'message': '0. [id155118230|Admin], money ∞, rating ∞\n' + top})
        ...
        малайский	ms	'})
                ...
                #     vk.method('messages.send', {'peer_id': id, 'message': 'https://vk.com/' + hr})  # отправляю сообщение
                ...
                elif len(body.lower().split()) == 1 and (len(body.lower().split('e')) == 1 or len(body.lower().split('е')) == 1):
                    ans = True
                    ...
                    request = apiai.ApiAI('5ef4fdfb36bb46728b64c62af81e5d97').text_request()  # Токен API к Dialogflow
